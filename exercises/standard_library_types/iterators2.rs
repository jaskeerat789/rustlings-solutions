...
pub fn capitalize_words_to_String(input: Vec<&str>) -> String{
    input.iter().map(|x| capitalize_first(x)).collect::<String>()
}
...
mod tests {
    ...
    fn test_iterate_into_string() {
        let words = vec!["hello", " ", "world"];
        let capitalized_words = capitalize_words_to_String(words);
        assert_eq!(capitalized_words, "Hello World");
    }
}
